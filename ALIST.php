...
{
$todel=$_GET['rno'];
mysqli_query($conn,"update appt SET ashow='N' where ano='$todel' ;");
}
$rs1=mysqli_query($conn,"SELECT * from appt where ashow='Y'");
$sno=1;
...
align=center>Options</td></tr>
<?php
$rs1=mysqli_query($conn,"SELECT * from appt where ashow='N'");
$sno=1;
while( $row=mysqli_fetch_array($rs1)) {
